...
const translations = {
  en: {
    ...
    addManualEmail: 'Add Manual Entry',
    manualEntryTitle: 'Enter New Customer Information',
    manualEntryDesc: 'Fill in the details below when a customer calls or contacts you',
    customerName: 'Name',
    customerEmail: 'Email',
    customerPhone: 'Phone Number',
    serviceType: 'Service Type',
    customerMessage: 'Message/Note',
    contactMethod: 'Contact Method',
    preferredDate: 'Preferred Date',
    preferredTime: 'Preferred Time',
    cancel: 'Cancel',
    saveToList: 'Save to List',
    emailAddedSuccess: 'Contact successfully added to the list!',
  ...
  tr: {
    ...
    addManualEmail: 'Manuel Giriş Ekle',
    manualEntryTitle: 'Yeni Müşteri Bilgileri Girin',
    manualEntryDesc: 'Bir müşteri aradığında veya iletişim kurduğunda aşağıdaki bilgileri doldurun',
    customerName: 'Ad',
    customerEmail: 'E-posta',
    customerPhone: 'Telefon Numarası',
    serviceType: 'Hizmet Türü',
    customerMessage: 'Mesaj/Not',
    contactMethod: 'İletişim Yöntemi',
    preferredDate: 'Tercih Edilen Tarih',
    preferredTime: 'Tercih Edilen Saat',
    cancel: 'İptal',
    saveToList: 'Listeye Kaydet',
    emailAddedSuccess: 'Kişi başarıyla listeye eklendi!',
  ...
  nl: {
    ...
    addManualEmail: 'Handmatige Invoer Toevoegen',
    manualEntryTitle: 'Nieuwe Klantgegevens Invoeren',
    manualEntryDesc: 'Vul onderstaande gegevens in wanneer een klant belt of contact opneemt',
    customerName: 'Naam',
    customerEmail: 'E-mail',
    customerPhone: 'Telefoonnummer',
    serviceType: 'Service Type',
    customerMessage: 'Bericht/Opmerking',
    contactMethod: 'Contactmethode',
    preferredDate: 'Gewenste Datum',
    preferredTime: 'Gewenste Tijd',
    cancel: 'Annuleren',
    saveToList: 'Opslaan in Lijst',
    emailAddedSuccess: 'Contact succesvol toegevoegd aan de lijst!',
