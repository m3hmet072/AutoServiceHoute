...
window.addEventListener('DOMContentLoaded', () => {
    ...
    renderHeroSection({
        ...
        titleHtml: `Airco Service<br><span class="accent">altijd koel onderweg</span>`,
        badgeText: 'Gecertificeerd airco specialist',
...
`,
        questions: [
            {
                title: 'Hoe vaak moet de airco onderhouden worden?',
                answer: 'Wij adviseren om elke 2 jaar het koudemiddel te laten controleren en bijvullen. Het pollenfilter vervangen we jaarlijks.'
            },
            {
                title: 'Mijn airco blaast niet koud, wat nu?',
                answer: 'Dit kan duiden op een tekort aan koudemiddel of een defect onderdeel. Maak een afspraak en wij stellen een gratis diagnose.'
            },
              {
                title: 'Werkt de airco ook in de winter?',
                answer: 'Ja! De airco ontvochtigt de lucht en helpt zo tegen beslagen ruiten. Regelmatig gebruik is goed voor het systeem.'
            }
        ]
    })
    ...
    renderControleSection({
        ...
        columns: 3,
        items: [
            'Airco check & diagnose',
            'Koudemiddel bijvullen (R134a / R1234yf)',
            'Compressor reparatie',
            'Condensor vervangen',
            'Lekkage opsporen',
            'Pollen- / interieurfilter vervangen'
    ...
    renderControleSection({
        serviceTitle: 'WAAROM ONDERHOUD?',
        containerId: 'controle-section-alt',
        columns: 3,
        items: ['Gezonde lucht', 'Zuiniger rijden', 'Langer meegaan'],
        title: 'Waarom airco onderhoud belangrijk is',
        subtitle: 'Goed onderhouden airco zorgt voor frisse lucht, voorkomt storingen en bespaart brandstof.',
        className: 'bg',
        noShadow: true
    })
