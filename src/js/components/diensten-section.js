...
export function renderDienstenSection() {
  const dienstenContainer = document.getElementById('diensten-section');
  if (!dienstenContainer) return;

  dienstenContainer.innerHTML = `
