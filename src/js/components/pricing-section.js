...
export function renderPricingSection({ title, price, subtitle, buttontext, minutes, reviews, svg } = {}) {
  const container = document.getElementById('pricing-section');
  if (!container) return;

  container.innerHTML = `  <section class="pricing-section">
    <div class="pricing-card">
     <div class="stat-icon">
      ...
      ${subtitle?.trim() ? `<p class="pricing-description">${subtitle.trim()}</p>` : ''}
      <div class="pricing-features">
       ...
       <a href="#contact" class="btn-afspraak">${buttontext}<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
