import"./base-ocf6tOUh.js";/* empty css               */import"./api-B3fETs2y.js";import{l as h,r as v,a as k,b as m,i as w,c as f}from"./footer-section-JEYM759Y.js";import{r as b}from"./pricing-section-SmS46JZg.js";import{r as j}from"./question-section-CHVjbGAM.js";import{r as C}from"./stappen-section-BCA8J1aQ.js";const $=[];let u=null;function B({containerId:s="product-section",products:e=[]}={}){const i=document.getElementById(s);if(!i)return;const t=e.length?e:$,o=new URL(window.location.href),l=o.searchParams.get("id")||o.searchParams.get("productId");if(l){const d=t.find(a=>String(a.id)===String(l));H(i,d);return}M(i,t)}function M(s,e){if(!e.length){s.innerHTML=`
