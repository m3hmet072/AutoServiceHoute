import"./base-BPhkRFgr.js";/* empty css               */import"./api-CLM0aaL7.js";import{l as h,r as v,a as k,b as m,i as w,c as f}from"./footer-section-DtAmPdQ4.js";import{r as b}from"./pricing-section-BdQbwE69.js";import{r as j}from"./question-section-CHVjbGAM.js";import{r as C}from"./stappen-section-C70fgUJ4.js";const $=[];let u=null;function B({containerId:s="product-section",products:e=[]}={}){const i=document.getElementById(s);if(!i)return;const t=e.length?e:$,o=new URL(window.location.href),l=o.searchParams.get("id")||o.searchParams.get("productId");if(l){const d=t.find(a=>String(a.id)===String(l));H(i,d);return}M(i,t)}function M(s,e){if(!e.length){s.innerHTML=`
