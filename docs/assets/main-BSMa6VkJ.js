import"./base-Cs-ev0D8.js";/* empty css               */import"./api-CLM0aaL7.js";import{l as t,r as o,a as i,b as s,c as r,i as n}from"./footer-section-Cj0po5pq.js";import{r as d}from"./pricing-section-CTUGAZtq.js";import{r as a}from"./stappen-section-CxeI3u5K.js";function l(){const e=document.getElementById("score-section");e&&(e.innerHTML=`
<section class="stats-section">
  ...
  `)}function c(){const e=document.getElementById("diensten-section");e&&(e.innerHTML=`
<section class="services" aria-labelledby="services-heading">
  ...
  <h2 id="services-heading">Alles voor uw auto onder één dak</h2>
  <h3 class="section-subtitle">Van APK tot airco — wij verzorgen het complete onderhoud en alle reparaties voor uw auto.</h3>
  <div class="services-grid">
    <div class="service-card blue">
      <div class="stat-icon">
        <svg width="32" height="16" viewBox="0 0 32 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M29.444 2.48963L30.0747 2.75519C28.9793 3.18672 28.0166 3.65145 27.1535 4.14938L26.2573 4.0166C27.0871 3.55187 28.249 2.98755 29.444 2.48963ZM31.6349 2.85477L25.8921 0C25.4606 0.06639 24.9959 0.13278 24.5975 0.19917L28.4813 1.89212C28.4149 1.95851 28.3485 1.95851 28.249 1.9917L24.0996 0.298755C23.3029 0.431535 22.5062 0.630705 21.8423 0.796681L25.5602 1.9917C25.3942 2.05809 25.3278 2.09129 25.1618 2.19087L21.1452 0.995851C19.9502 1.3278 18.722 1.72614 17.0954 2.39004L24.6971 3.71784C24.4979 3.81743 24.3651 3.91701 24.1328 4.0166L16.0664 2.82158C14.1411 3.65145 11.917 4.91286 10.1245 6.07469H18.0581C17.6929 6.30705 17.3942 6.50622 16.9627 6.80498L8.6639 7.07054C7.13693 8.16597 5.57676 9.46058 4.6805 10.2573C3.78423 11.0207 1.19502 13.6432 0 16L9.69295 13.4772C9.26141 14.1079 8.89627 14.805 8.6971 15.4025L19.2199 12.0498C19.1203 9.59336 21.5104 7.40249 23.1037 6.07469H24.4315C22.3734 7.83402 21.4108 9.79253 21.6763 11.2863L24.9627 10.2573C24.1992 8.19917 26.3568 4.58091 31.6349 2.85477Z" fill="#F5F8FF" />
        </svg>
      </div>
      <div class="service-text-container">
        <h3>APK Keuring</h3>
        <p>Officiële RDW erkende APK keuring.<br>Snel en betrouwbaar, vaak dezelfde dag klaar.</p>
      </div>
      <div class="meerinfo">
        <a href="apk.html" class="btn-meerinfo">Meer info <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15.417 10H4.16699" stroke="#F5F8FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M10.833 15C10.833 15 15.833 11.3176 15.833 10C15.833 8.68233 10.833 5 10.833 5" stroke="#F5F8FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
        </a>
      </div>
    </div>
    <div class="service-card">
      ...
      <div class="service-text-container">
        <h3>Grote beurt</h3>
        <p>Complete onderhoudsbeurt volgens<br>fabrieksvoorschriften. Inclusief alle vloeistoffen en filters.</p>
      </div>
      <div class="meerinfo">
        <a href="onderhoud.html" class="btn-meerinfo">Meer info <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15.417 10H4.16699" stroke="#0082FB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M10.833 15C10.833 15 15.833 11.3176 15.833 10C15.833 8.68233 10.833 5 10.833 5" stroke="#0082FB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
        </a>
      </div>
    </div>
    <div class="service-card">
      ...
      <div class="service-text-container">
        <h3>Banden Service</h3>
        <p>Banden wisselen, uitlijnen en balanceren. Alle topmerken op voorraad tegen scherpe prijzen.</p>
      </div>
      <div class="meerinfo">
        <a href="banden.html" class="btn-meerinfo">Meer info <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15.417 10H4.16699" stroke="#0082FB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M10.833 15C10.833 15 15.833 11.3176 15.833 10C15.833 8.68233 10.833 5 10.833 5" stroke="#0082FB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
        </a>
    ...
    <div class="service-card">
      ...
      <div class="service-text-container">
        <h3>Airco Specialist</h3>
        <p>Airco check, bijvullen en reparatie. Rij comfortabel de zomer door met een goed werkende airco.</p>
      </div>
      <div class="meerinfo">
        <a href="airco.html" class="btn-meerinfo">Meer info <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15.417 10H4.16699" stroke="#0082FB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M10.833 15C10.833 15 15.833 11.3176 15.833 10C15.833 8.68233 10.833 5 10.833 5" stroke="#0082FB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
        </a>
  ...
  `)}t();document.addEventListener("DOMContentLoaded",()=>{o(),d(),i(),a(),l(),c(),s(),r(),n()});
