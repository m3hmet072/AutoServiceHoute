import"./navbar-B0iLMJZN.js";import{l as h,r as v,a as k,b as m,i as w,c as f}from"./footer-section-CuK8fjKZ.js";import{r as b}from"./pricing-section-COm9zhhV.js";import{r as j}from"./question-section-CHVjbGAM.js";import{r as C}from"./stappen-section-pOcSMmZV.js";const $=[];let u=null;function B({containerId:s="product-section",products:e=[]}={}){const i=document.getElementById(s);if(!i)return;const t=e.length?e:$,o=new URL(window.location.href),l=o.searchParams.get("id")||o.searchParams.get("productId");if(l){const d=t.find(a=>String(a.id)===String(l));H(i,d);return}M(i,t)}function M(s,e){if(!e.length){s.innerHTML=`
